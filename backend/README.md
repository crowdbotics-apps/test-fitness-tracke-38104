...
## Project Structure
    ...
    ├── test_fitness_tracke_38104  # Django project configurations
...
1. Clone this repo and `cd test_fitness_tracke_38104`
...
2. Clone this repo and `cd test_fitness_tracke_38104`
